...
(function () {
  ...
  window.UniversalPrinter = { state, connect, disconnect, printOrder, testPrint, autoPrintOrder, setAutoPrint, openPanel, closePanel, updateUI, buildOrder };
